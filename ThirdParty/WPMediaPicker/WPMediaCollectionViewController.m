...
- (instancetype)initWithArray:(NSArray*)selectpicArray
{
    UICollectionViewFlowLayout *layout = [[UICollectionViewFlowLayout alloc] init];
    self = [self initWithCollectionViewLayout:layout];
    if (self) {
        _layout = layout;
        _selectedAssets = [[NSMutableArray alloc] initWithArray:selectpicArray];
...
- (void)viewDidLoad
{
    ...
    self.collectionView.backgroundColor=COLOR(c_ffffff);

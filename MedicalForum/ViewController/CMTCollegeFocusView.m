...
#import "CMTCollegeFocusView.h"               // header file
...
@implementation CMTCollegeFocusView
...
// 获取指定的焦点图信息
- (CMTSeriesDetails *)focusAtIndex:(NSInteger)index {
...
- (void)reloadData {
    ...
    for (NSInteger index = 0; index < numberOfFocus; index++) {
        CMTSeriesDetails *focus = [self focusAtIndex:index];
        ...
        [imageView setLimitedImageURL:focus.picUrl placeholderImage:IMAGE(@"focus_default")];
        [self.scrollView addSubview:imageView];
    }
    
    // 最左侧补充最后一张焦点图
    CMTSeriesDetails *lastFocus = [self focusAtIndex:numberOfFocus - 1];
    ...
    [lastFocusImageView setLimitedImageURL:lastFocus.picUrl placeholderImage:IMAGE(@"focus_default")];
    [self.scrollView addSubview:lastFocusImageView];
    
    // 最后侧补充第一张焦点图
    CMTSeriesDetails *firstFocus = [self focusAtIndex:0];
    ...
    [firstFocusImageView setLimitedImageURL:firstFocus.picUrl placeholderImage:IMAGE(@"focus_default")];
